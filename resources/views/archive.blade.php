...
<div x-data="{ 
    ...
    <div class="mt-8 p-4 bg-yellow-500/10 rounded-lg border border-yellow-500/30">
        ...
        <a href="/archive/6" class="block px-4 py-3 rounded-lg {{ $module->id == 6 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">📊</span>
                <div class="flex-1 min-w-0">
        ...
        <a href="/archive/7" class="block px-4 py-3 rounded-lg {{ $module->id == 7 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">📈</span>
                <div class="flex-1 min-w-0">
        ...
        <a href="/archive/8" class="block px-4 py-3 rounded-lg {{ $module->id == 8 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🔌</span>
                <div class="flex-1 min-w-0">
        ...
        <a href="/archive/9" class="block px-4 py-3 rounded-lg {{ $module->id == 9 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🎲</span>
                <div class="flex-1 min-w-0">
        ...
        <a href="/archive/10" class="block px-4 py-3 rounded-lg {{ $module->id == 10 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🇫🇷</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">French I</p>
                    <p class="text-xs opacity-70">FR I resources</p>
                </div>
            </div>
        </a>
        <a href="/archive/11" class="block px-4 py-3 rounded-lg {{ $module->id == 11 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🇪🇳</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">English II</p>
                    <p class="text-xs opacity-70">En II resources</p>
                </div>
            </div>
        </a>
    </nav>
        ...
        <div class="flex gap-6 overflow-x-auto pb-2">
            ...
            <div 
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex items-center justify-between p-4 bg-white/[0.02] rounded-xl border border-white/[0.03] transition-all duration-300 hover:bg-white/[0.04] hover:border-yellow-600/20 hover:scale-[1.02] group">
                        <a href="{{ route('files.download', $file->id) }}" class="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        {{-- Delete Button --}}
                        <button 
                            onclick="deleteFile({{ $file->id }}, '{{ addslashes($file->filename) }}')" 
                            class="ml-2 w-8 h-8 bg-red-600 rounded-lg flex items-center justify-center border border-red-500 hover:bg-red-700 transition-all flex-shrink-0 shadow-lg"
                            title="Delete file">
...
<div x-data="{ 
    ...
    <div class="mt-8 p-4 bg-yellow-500/10 rounded-lg border border-yellow-500/30">
        ...
        <a href="/archive/12" class="block px-4 py-3 rounded-lg {{ $module->id == 12 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🖼️</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Images Treatment</p>
                    <p class="text-xs opacity-70">Traitement d'images resources</p>
                </div>
            </div>
        </a>
        
        <a href="/archive/13" class="block px-4 py-3 rounded-lg {{ $module->id == 13 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🤖</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">IA</p>
                    <p class="text-xs opacity-70">IA resources</p>
                </div>
            </div>
        </a>
        
        <a href="/archive/14" class="block px-4 py-3 rounded-lg {{ $module->id == 14 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🎨</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Graphical IT</p>
                    <p class="text-xs opacity-70">IG resources</p>
                </div>
            </div>
        </a>
        
        <a href="/archive/15" class="block px-4 py-3 rounded-lg {{ $module->id == 15 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🚀</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Optimisation</p>
                    <p class="text-xs opacity-70">Optimisation resources</p>
                </div>
            </div>
        </a>
        
        <a href="/archive/16" class="block px-4 py-3 rounded-lg {{ $module->id == 16 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🔄</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Data Interchange Standards</p>
                    <p class="text-xs opacity-70">SED resources</p>
                </div>
            </div>
        </a>
        <a href="/archive/17" class="block px-4 py-3 rounded-lg {{ $module->id == 17 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">📡</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Technical IP</p>
                    <p class="text-xs opacity-70">IP resources</p>
                </div>
            </div>
        </a>
        <a href="/archive/18" class="block px-4 py-3 rounded-lg {{ $module->id == 18 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">⏱️</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Complexity</p>
                    <p class="text-xs opacity-70">Complexity resources</p>
                </div>
            </div>
        </a>
        <a href="/archive/19" class="block px-4 py-3 rounded-lg {{ $module->id == 19 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🔧</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Compilation</p>
                    <p class="text-xs opacity-70">Compilation resources</p>
                </div>
            </div>
        </a>
        <a href="/archive/20" class="block px-4 py-3 rounded-lg {{ $module->id == 20 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🛡️</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Network Security</p>
                    <p class="text-xs opacity-70">Security resources</p>
                </div>
            </div>
        </a>
        <a href="/archive/21" class="block px-4 py-3 rounded-lg {{ $module->id == 21 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🧩</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">Object Oriented Conception</p>
                    <p class="text-xs opacity-70">COO resources</p>
                </div>
            </div>
        </a>
        <a href="/archive/22" class="block px-4 py-3 rounded-lg {{ $module->id == 22 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🇪🇳</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">English II</p>
        ...
        <a href="/archive/23" class="block px-4 py-3 rounded-lg {{ $module->id == 23 ? 'bg-yellow-500/20 text-yellow-500 border border-yellow-500/30' : 'text-slate-300 hover:bg-white/5 border border-transparent' }} transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🇫🇷</span>
                <div class="flex-1 min-w-0">
                    <p class="font-medium truncate">French II</p>
                    <p class="text-xs opacity-70">Fr II resources</p>
                </div>
            </div>
        </a>
